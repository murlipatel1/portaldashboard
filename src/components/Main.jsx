...
const Main = () => {
    return (
        <>
            ...
            <div className='mx-8 flex sm:flex-col'><div className='flex flex-col sm:pb-4'><p className="font-bold text-white px-2">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Rem neque sed, enim eum id similique odit accusantium quos, perferendis aspernatur nobis animi cum vitae at incidunt illo quae sint! Omnis ratione quidem veniam dolorum?Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus possimus, animi similique omnis ratione consequuntur perferendis! Praesentium totam voluptas eum! Facere impedit veritatis natus officia quae quas aperiam recusandae commodi, atque quasi assumenda sapiente.</p><button type="button" className="text-white bg-[#F68C1F] hover:bg-orange-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center   self-center w-64 mt-auto ">Manage Student Relation</button></div><img className='h-96 ' src={fourthimage} alt="" /></div>
            </div>
...
Along with this, a proper pathway wil be provided to students to build a perfect resume they desire for.
</p><button type="button" className="text-white bg-[#1F3368] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center   self-center w-64 mt-auto  ">Manage It Now!</button></div></div>
            </div>
            ...
            <div className='mx-8 flex sm:flex-col'><img className='h-96 ' src={seventhimage} alt="" /><div className='flex flex-col sm:pb-4'><p className="font-bold  px-2">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Rem neque sed, enim eum id similique odit accusantium quos, perferendis aspernatur nobis animi cum vitae at incidunt illo quae sint! Omnis ratione quidem veniam dolorum?Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores esse officiis aperiam hic eos doloremque fugit nulla ex repellendus, soluta nobis provident dolores, ad quasi fugiat repellat deserunt error corrupti ab rem. Fugit, possimus?</p><button type="button" className="text-white bg-[#1F3368] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center   self-center w-64 mt-auto  ">Go To Forum</button></div></div>
            </div>
            ...
            <div className='mx-8 flex sm:flex-col'><div className='flex flex-col sm:pb-4 '><p className="font-bold px-2 text-white">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Rem neque sed, enim eum id similique odit accusantium quos, perferendis aspernatur nobis animi cum vitae at incidunt illo quae sint! Omnis ratione quidem veniam dolorum?Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est, ipsum repudiandae, ducimus officia id omnis quisquam ut at, in doloremque quae nostrum iusto doloribus! Cumque commodi ea, error iure eum nihil eos ipsam eius.</p><button type="button" className="text-white bg-[#F68C1F] hover:bg-orange-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center   self-center w-64 mt-auto  ">Guide to Placement</button></div><img className='h-96 ' src={tenthimage} alt="" /></div>
            </div>
