  ...
  return (
	...
	<div className="space-y-4 text-center ">  {/*divide-y divide-gray-700*/}
		<div className="my-2 space-y-1">
			<h2 className="text-xl text-[#1F3368] font-semibold sm:text-2xl">Leroy Jenkins</h2>
			<p className="px-5 text-xs text-[#1F3368] sm:text-base ">Computer Engineer</p>
			<p className="px-5 text-xs sm:text-base text-[#F68C1F] ">21BCP107</p>
		</div>
    ...
    <button type="button" className="text-white bg-[#1F3368] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center   self-center w-64 mt-1  ">Details</button>
    </div>
</div>
    </>
  )
...
export default ManageStudentCard